"""Regression checks for the secretroll casebook."""
...
from casebook.harness import assert_expected, secretroll_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(secretroll_summary(), assert_expected())
