...
`secretroll` is centered on platform security work in Swift. The technical target is: Plan secret rotation windows and audit-friendly stale credential reports.
...
The score is deterministic. The current threshold is 171. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 2.
